...
export default function Home() {
  ...
  <section className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-12 md:mb-20">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-base text-gray-400 mb-4 max-w-xl md:hidden">I specialize in building robust backend systems and scalable web applications using Python, Django, and FastAPI. Experienced in architecting RESTful APIs, optimizing database performance, and integrating third-party services for seamless scalability. I manage end-to-end delivery — from backend architecture and deployment pipelines to ensuring quality and performance standards across development stages. Additionally, I handle client communication and maintain key documentation, including proposals, invoices, and agreements.
</p>
